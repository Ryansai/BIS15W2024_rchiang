...
```
```{r}
z = 30  #do not use #hashtag makes R not recognize as code
q <- 42
```
...
This is useful because it removes the NA from the data. This means that NAs affect R's ability to complete a function.
